...
Es folgen in \autoref{tab:dev_eval} die Ergebnisse der Evaluation gegen den Development-Split während des Trainings. Es zeigt sich ein klarer Vorsprung der Performance auf WikiANN.


\begin{table}[!htbp]
	\centering
	\caption{Evaluation der Development-Splits}
	\label{tab:dev_eval}
	\begin{tabular}{@{}llll|l@{}}
		\toprule
		\textbf{Korpus} & \textbf{f1}     & \textbf{precision} & \textbf{recall} & \textbf{Trainingsdauer \ (in Min.)} \\ \midrule
		GermEval2014    & 0.8111          & 0.8369             & 0.7867          & 200                               \\
		WikiANN         & \textbf{0.8841} & \textbf{0.8994}    & \textbf{0.8692} & 223                               \\
		MultiNERD       & 0.8578          & 0.8625             & 0.8532          & 644                               \\ \bottomrule
	\end{tabular}
\end{table}
