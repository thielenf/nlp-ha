...
DATA_DIR=/media/data/thielen/nlp-ha/datasets/WikiANN/mrc-ner
...
OUTPUT_DIR=/media/data/thielen/nlp-ha/outputs/github_mrc/wikiann/large_lr${LR}_drop${MRC_DROPOUT}_norm${MAXNORM}_bsz32_hard_span_weight${SPAN_WEIGHT}_warmup${WARMUP}_maxlen${MAXLEN}
mkdir -p ${OUTPUT_DIR}
