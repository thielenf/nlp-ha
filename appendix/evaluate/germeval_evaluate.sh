...
OUTPUT_DIR=/media/data/thielen/nlp-ha/outputs/github_mrc/germeval2014/large_lr2e-5_drop0.2_norm1.0_bsz32_hard_span_weight0.1_warmup0_maxlen180
# find best checkpoint on dev in ${OUTPUT_DIR}/train_log.txt
BEST_CKPT_DEV=${OUTPUT_DIR}/epoch=6.ckpt
